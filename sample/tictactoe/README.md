...
- [2. Getting Started](#2-getting-started)
  ...
  * [b. Tictactoe binding](#b-tictactoe-binding)
        * [Init json](#init-json)
        * [GetSmartContractInit](#getsmartcontractinit)
        * [Binding](#binding)
        * [GetSmartContractState](#getsmartcontractstate)
        * [Call transitions](#call-transitions)
  * [c. Lobby Popup](#c-lobby-popup)
      - [UI needed](#ui-needed)
          + [Main lobby panel](#main-lobby-panel)
          + [Contract state panel](#contract-state-panel)
          + [Import contract panel](#import-contract-panel)
      - [Main actions](#main-actions)
        * [Fill Contract State](#fill-contract-state)
        * [Deploy](#deploy)
        * [Host Action](#host-action)
        * [Challenger Action](#challenger-action)
        * [Common Action](#common-action)
  * [d. Tictactoe Gameplay](#d-tictactoe-gameplay)
...
## a. Hello Zilliqa
Assume you already have this in [here](https://github.com/paladinlll/zilliqa-cocos-sdk).
## b. Tictactoe binding
...
##### Init json
* Quick function to get init json from params.
    ```ts
...
* callMove
    ...
    *All was have same format so I just show you one for demo*
    ...
    ```
## c. Lobby Popup
This was be used to deploy a contract, view contract state, invokes transitions to contract. 
#### UI needed
